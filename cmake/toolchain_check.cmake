...
set(tc_ldflags "-fuse-ld=lld -flto-jobs=${MAKEJOBS} -Wl,--lto-whole-program-visibility,-Bsymbolic,--build-id=none,-O3,--lto-O3,--lto-CGO3,--icf=all,--gc-sections,-znow,-zrodynamic,-zpack-relative-relocs,-zcommon-page-size=2097152,-zmax-page-size=2097152,-zseparate-loadable-segments,-zkeep-text-section-prefix,-zstart-stop-visibility=hidden,-mllvm,-enable-vtable-value-profiling,-mllvm,-enable-vtable-profile-use,-mllvm,-import-instr-limit=100,-mllvm,-import-hot-multiplier=3,-mllvm,-tailcallopt")
...
set(llvm_mllvm "${llvm_mllvm} -mllvm -adce-remove-loops -mllvm -enable-ext-tsp-block-placement -mllvm -enable-gvn-hoist -mllvm -enable-gvn-sink=false -mllvm -sink-common-insts=false -mllvm -vectorizer-maximize-bandwidth -mllvm -combiner-global-alias-analysis -mllvm -optimize-regalloc -mllvm -misched-postra -mllvm -gc-empty-basic-blocks -mllvm -enable-merge-functions -mllvm -mergefunc-use-aliases -mllvm -enable-jump-table-to-switch -mllvm -enable-loop-flatten -mllvm -enable-early-exit-vectorization -mllvm -enable-loop-versioning-licm -mllvm -slp-revec -mllvm -slp-vectorize-non-power-of-2 -mllvm -enable-memcpyopt-without-libcalls -mllvm -pgso=false -mllvm -enable-ipra -mllvm -lv-strided-pointer-ivs -mllvm -enable-dfa-jump-thread -mllvm -force-ordered-reductions -mllvm -inline-enable-cost-benefit-analysis -mllvm -inline-priority-mode=cost-benefit -mllvm -inline-threshold=360 -mllvm -inlinedefault-threshold=360 -mllvm -inlinehint-threshold=525")
...
if(TARGET_CPU STREQUAL "x86_64")
    ...
    set(MLLVM_FLAGS "${llvm_mllvm} ${polly}")
    if(MARCH_HAS_AVX)
        ...
        if(MARCH_HAS_AVX512)
            ...
            set(MLLVM_FLAGS "${MLLVM_FLAGS} -mllvm -x86-use-fsrm-for-memcpy -mllvm -enable-histogram-loop-vectorization")
...
elseif(TARGET_CPU STREQUAL "aarch64")
    ...
    set(MLLVM_FLAGS "${llvm_mllvm} -mllvm -enable-ipra=false -mllvm -slp-vectorize-non-power-of-2=false")
    if(MARCH_HAS_SVE2)
