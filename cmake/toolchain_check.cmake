...
if(CUSTOM_LIBCXX)
    ...
    set(tc_cflags "${tc_cflags} -fexperimental-library")
endif()
if(CUSTOM_COMPILER_RT)
    set(tc_compiler_rt "-resource-dir=${CMAKE_INSTALL_PREFIX}/lib/clang/${clang_version}")
endif()
