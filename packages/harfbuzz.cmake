ExternalProject_Add(harfbuzz
    ...
    CONFIGURE_COMMAND ${EXEC} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_C_FLAGS='-DHAVE_SINCOS -DHAVE_SINCOSF -DHB_NO_LEGACY -DHB_NO_PRAGMA_GCC_DIAGNOSTIC_ERROR'"
        "-DCMAKE_CXX_FLAGS='-DHAVE_SINCOS -DHAVE_SINCOSF -DHB_NO_LEGACY -DHB_NO_PRAGMA_GCC_DIAGNOSTIC_ERROR'"
