ExternalProject_Add(ccache
    ...
    CONFIGURE_COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_C_FLAGS='-DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DXXH_ENABLE_AUTOVECTORIZE -DXXH_NO_PREFETCH -DNO_PREFETCH ${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo}'"
        "-DCMAKE_CXX_FLAGS='-DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DXXH_ENABLE_AUTOVECTORIZE -DXXH_NO_PREFETCH -DNO_PREFETCH -include cstdlib -include algorithm ${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo}'"
        "-DCMAKE_ASM_FLAGS='-DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DXXH_ENABLE_AUTOVECTORIZE -DXXH_NO_PREFETCH -DNO_PREFETCH ${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo}'"
