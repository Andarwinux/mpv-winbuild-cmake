ExternalProject_Add(ccache
    ...
    CONFIGURE_COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_CXX_FLAGS='-DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DXXH_ENABLE_AUTOVECTORIZE -include cstdlib -include algorithm ${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo}'"
