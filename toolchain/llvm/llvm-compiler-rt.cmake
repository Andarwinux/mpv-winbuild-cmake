ExternalProject_Add(llvm-compiler-rt
    ...
    UPDATE_COMMAND ""
    SOURCE_DIR ${LLVM_SRC}
    CONFIGURE_COMMAND ${EXEC} CONF=1 ${CMAKE_COMMAND} -H<SOURCE_DIR>/compiler-rt -B<BINARY_DIR>
        ${cmake_conf_args}
    ...
    BUILD_COMMAND ${EXEC} PACKAGE=${package} BINARY_DIR=<BINARY_DIR> LTO=0 PGO=0 RTTI=1 ninja -C <BINARY_DIR>
