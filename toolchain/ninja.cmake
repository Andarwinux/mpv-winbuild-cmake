ExternalProject_Add(ninja
    ...
    GIT_TAG master
    CONFIGURE_COMMAND ${EXEC_HOST} sed -i [['/CMAKE_INTERPROCEDURAL_OPTIMIZATION_RELEASE/d']] <SOURCE_DIR>/CMakeLists.txt
    COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_CXX_FLAGS='${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo} -include cstdlib'"
