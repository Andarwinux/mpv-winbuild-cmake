ExternalProject_Add(rustup
    ...
    BUILD_COMMAND ${EXEC} GOBIN=${CMAKE_INSTALL_PREFIX}/bin go install go.chromium.org/luci/cipd/client/cmd/...@latest
          ...
          COMMAND ${EXEC} cipd install fuchsia/third_party/rust_newllvm/host/linux-amd64 latest -root ${RUSTUP_LOCATION} -force
          COMMAND ${EXEC} cipd install fuchsia/third_party/rust_newllvm/target/x86_64-unknown-linux-gnu latest -root ${RUSTUP_LOCATION} -force
