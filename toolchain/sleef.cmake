ExternalProject_Add(sleef
    ...
    CONFIGURE_COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>/host
        ...
        "-DCMAKE_C_FLAGS='-g0'"
        "-DCMALE_CXX_FLAGS='-g0'"
    COMMAND ${EXEC} ninja -C <BINARY_DIR>/host mkunroll mkrename mkdisp mkalias mkdisp mkdispatch mkrename_gnuabi mkmasked_gnuabi addSuffix
    ...
    INSTALL_COMMAND ${EXEC} ${CMAKE_COMMAND} --install <BINARY_DIR>
            ...
            COMMAND ${EXEC} ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/sleefmathinline.c <BINARY_DIR>/sleefmathinline.c
            COMMAND ${EXEC} ${TARGET_ARCH}-clang -c sleefmathinline.c -o ${MINGW_INSTALL_PREFIX}/lib/sleefmathinline.o
