...
#include <sleefinline_purecfma_scalar.h>
                               ...
                               double    frexp(double x, int *exp){return (*exp = Sleef_expfrexpd1_purecfma(x), Sleef_frfrexpd1_purecfma(x));}
                               ...
                               double    modf(double x, double *iptr){vdouble2_purecfma_scalar_sleef r = Sleef_modfd1_purecfma(x);return (*iptr = r.y, r.x);}
                               ...
                               float     frexpf(float x, int *exp){return (*exp = Sleef_expfrexpf1_purecfma(x), Sleef_frfrexpf1_purecfma(x));}
                               float     ldexpf(float x, int exp){return Sleef_ldexpf1_purecfma(x, exp);}
                               float     modff(float x, float *iptr){vfloat2_purecfma_scalar_sleef r = Sleef_modff1_purecfma(x); return (*iptr = r.y, r.x);}
                               float     scalbnf(float x, int n){return Sleef_ldexpf1_purecfma(x, n);}
                               int       ilogb(double x){return Sleef_ilogbd1_purecfma(x);}
                               int       ilogbf(float x){return Sleef_ilogbf1_purecfma(x);}
                               long long llround(double x){return (long long)(Sleef_roundd1_purecfma(x));}
                               long long llroundf(float x){return (long long)(Sleef_roundf1_purecfma(x));}
                               long      lround(double x){return (long)(Sleef_roundd1_purecfma(x));}
                               long      lroundf(float x){return (long)(Sleef_roundf1_purecfma(x));}
__attribute__((always_inline)) void      sincos(double x, double *s, double *c){vdouble2_purecfma_scalar_sleef r = Sleef_sincosd1_u35purecfma(x); *s = r.x; *c = r.y;}
__attribute__((always_inline)) void      sincosf(float x, float *s, float *c){vfloat2_purecfma_scalar_sleef r = Sleef_sincosf1_u35purecfma(x); *s = r.x; *c = r.y;}
