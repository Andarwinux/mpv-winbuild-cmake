...
__attribute__((always_inline,hot))                    double    asinh(double x){return Sleef_asinhd1_u10purecfma(x);}
__attribute__((always_inline,hot))                    double    atan(double x){return Sleef_atand1_u35purecfma(x);}
...
__attribute__((always_inline,hot))                    double    exp(double x){return Sleef_expd1_u10purecfma(x);}
...
__attribute__((always_inline,hot))                    double    ldexp(double x, int exp){return Sleef_ldexpd1_purecfma(x, exp);}
                                                      #endif
__attribute__((always_inline,hot))                    double    log(double x){return Sleef_logd1_u10purecfma(x);}
__attribute__((always_inline,hot))                    double    log10(double x){return Sleef_log10d1_u10purecfma(x);}
__attribute__((always_inline,hot))                    double    log1p(double x){return Sleef_log1pd1_u10purecfma(x);}
__attribute__((always_inline,hot))                    double    log2(double x){return Sleef_log2d1_u35purecfma(x);}
__attribute__((always_inline,hot))                    double    modf(double x, double *iptr){vdouble2_purecfma_scalar_sleef r = Sleef_modfd1_purecfma(x);return (*iptr = r.y, r.x);}
...
__attribute__((always_inline,hot))                    float     asinf(float x){return Sleef_asinf1_u35purecfma(x);}
__attribute__((always_inline,hot))                    float     asinhf(float x){return Sleef_asinhf1_u10purecfma(x);}
__attribute__((always_inline,hot))                    float     atan2f(float y, float x){return Sleef_atan2f1_u35purecfma(y, x);}
...
__attribute__((always_inline,hot))                    float     exp2f(float x){return Sleef_exp2f1_u35purecfma(x);}
...
__attribute__((always_inline,hot))                    float     ldexpf(float x, int exp){return Sleef_ldexpf1_purecfma(x, exp);}
                                                      #endif
__attribute__((always_inline,hot))                    float     log10f(float x){return Sleef_log10f1_u10purecfma(x);}
__attribute__((always_inline,hot))                    float     log1pf(float x){return Sleef_log1pf1_u10purecfma(x);}
__attribute__((always_inline,hot))                    float     log2f(float x){return Sleef_log2f1_u35purecfma(x);}
