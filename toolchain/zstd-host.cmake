ExternalProject_Add(zstd-host
    ...
    CONFIGURE_COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR>/build/cmake -B<BINARY_DIR>
        ...
        "-DCMAKE_C_FLAGS='${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo} -DZSTD_DISABLE_ASM -DZSTD_TRACE=0 -DXXH_NO_PREFETCH -DNO_PREFETCH'"
        "-DCMAKE_CXX_FLAGS='${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo} -DZSTD_DISABLE_ASM -DZSTD_TRACE=0 -DXXH_NO_PREFETCH -DNO_PREFETCH'"
        "-DCMAKE_ASM_FLAGS='${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo} -DZSTD_DISABLE_ASM -DZSTD_TRACE=0 -DXXH_NO_PREFETCH -DNO_PREFETCH'"
